...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">Zenix Job Portal Web App</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="https://www.linkedin.com/in/aryanshrivastav2005/">Contact</a>
                </li>
            </ul>
        </div>
    </div>
...
<%-- request is an implicity passed object of httpServletRequest class --%>
<%
